...
source("/Functions/SignaturePlots.R")
...
######
# make Signature barplots -- Figure 1B (functions defined in SignaturePlots.R)
...
source("/Functions/OncoprintPlots.R")
...
source("/Functions/CopyNumberPlots.R")
